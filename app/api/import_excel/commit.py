...
from app.crud.weekly_menu import weekly_menu_crud

router = APIRouter()


# まずは preview から返ってくる JSON を受けるための Payload 定義
...
class ImportPayload(BaseModel):
    ...
    weekly_menu_items: List[str]   # vendor_item_id のリスト
